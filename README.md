...
Há pastas principais cada uma contendo um projeto/projetos de minha autoria os quais são organizados diferentemente. Segue uma síntese para cada um deles, e detalhes sobre suas organizações encontram-se no seus respectivos arquivos README.md dentro de cada pasta:
- Grand Machinery: Um projeto de jogo desenvolvido no Gamemaker Studio 2 (GM2).
...
- Desenvolvimento de Sistemas Web: Compilado de projetos próprios envolvendo HTML5, JavaScript, CSS e SQL. Todos foram realizados na escola onde estudo, o IFRS campus Bento Gonçalves no curso Informática para Internet.
